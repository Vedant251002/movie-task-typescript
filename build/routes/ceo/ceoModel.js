...
async function getCinema(cinemaHall) {
    let query = `
...
async function seatDb({ city, movie, cinema, hall, time }) {
...
async function releaseDateDb(year) {
...
async function who_bookedDb({ cinema, movie }) {
    let query = `
